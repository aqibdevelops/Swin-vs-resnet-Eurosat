...
def main():
    parser = argparse.ArgumentParser(description='Train ResNet50 on EuroSAT')
    ...
    # Model setup
    # Using resnet50 and resizing input to 128x128
    ...
    optimizer = optim.AdamW(model.fc.parameters(), lr=5e-4, weight_decay=0.05)
